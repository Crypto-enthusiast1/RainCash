...
export const useWallet = () => {
    ...
    const setupConnection = async () => {
        ...
        try {
            ...
            console.log("Contract deposit method:", contractInstance.deposit);
            console.log("Contract withdraw method:", contractInstance.withdraw);
            console.log("Contract feePercentage method:", contractInstance.feePercentage);
